...
class TrainDbHandler {
  ...
  Future<void> initTrains() async {
    ...
    Train t1 = Train(
        ...
        pnr: "8343367217",
        departure:
            DateTime.parse("2021-12-16 19:30:00").microsecondsSinceEpoch,
    ...
    Train t2 = Train(
        ...
        pnr: "8343367318",
        departure:
        DateTime.parse("2021-12-17 21:50:00").microsecondsSinceEpoch,
  ...
  Future<List<Train?>?> getTrainsForTrip(String tripId) async {
    final db = await DbHelper.instance.db;
